...
class AdminColors {
  ...
  // Main brand blue
  static const Color primaryLight = Color(0xFF1499D5);

  // Brighter Sky / Turquoise
  ...
  // Generic utility blue now follows Darbi brand
  ...
  static const Color darkBackground = Color(0xFF081115);
  ...
  static const Color sidebarItemTextDark = Color(0xFF94A3B8);

  // Darbi light blue active item
  static const Color sidebarActiveBgLight = Color(0xFFE0F7FA);

  // Transparent Darbi blue
  static const Color sidebarActiveBgDark = Color(0x2620B4D8);
  ...
  // but use Darbi cyan instead of Indigo.
