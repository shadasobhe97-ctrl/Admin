...
class WithdrawalsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (!PermissionHelper.hasPermission('financial.manage_withdrawals')) {
      return Scaffold(
        backgroundColor: context.scaffoldBackgroundColor,
        appBar: AppBar(
          backgroundColor: context.cardColor,
          elevation: 0,
          title: Text('طلبات السحب', style: TextStyle(color: context.textPrimary, fontWeight: FontWeight.bold)),
        ),
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'إدارة ومعالجة طلبات سحب الأرباح تتطلب صلاحية (financial.manage_withdrawals).',
...
class _WithdrawalsViewState extends State<_WithdrawalsView> {
  ...
  void _applyFilters({int page = 1}) {
    ...
    context.read<FinancialCubit>().loadWithdrawals(
          status: _status,
          search: search,
