...
class RechargesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (!PermissionHelper.hasPermission('financial.manage_recharges')) {
      return Scaffold(
        backgroundColor: context.scaffoldBackgroundColor,
        appBar: AppBar(
          backgroundColor: context.cardColor,
          elevation: 0,
          title: Text('طلبات شحن المحافظ', style: TextStyle(color: context.textPrimary, fontWeight: FontWeight.bold)),
        ),
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'إدارة ومعالجة طلبات شحن المحافظ تتطلب صلاحية (financial.manage_recharges).',
